	...
	return (
		<Formik initialValues={{displayName: '', username: '', email: '', password: '', error: null}}
		        ...
		        validationSchema={Yup.object({
			        ...
			        password: Yup.string().min(8, "password is too short - password must be at least 8 character and contain at least 1 UpperCase , 1 lowerCase, 1 Number").required("password must be at least 8 character and contain at least 1 UpperCase , 1 lowerCase, 1 Number   "),
		        })}
		>
