		...
		<Segment.Group>
			<Segment basic attached='top' style={{padding: '0'}}>
				{(activity.isCancelled) &&
					<Label style={{position: 'absolute', zIndex: 1000, left: -15, top: 20}} ribbon={true} color={"red"} content={"Cancelled"}/>
				}
			...
			<Segment clearing attached='bottom'>
				{activity.isHost ? (
					...
					<Fragment>
						...
						<Button color={activity.isCancelled ? 'green' : 'red'} floated={"left"} basic={true}
						        content={activity.isCancelled ? 'Re-Activate Activity' : 'Cancel Activity'} onClick={cancelActivityToggle}
						        loading={loading}/>
